...
def load_settings(request):
	return {
			...
			'FORCE_SHOW_SERVER': settings.MOOSHELL_FORCE_SHOW_SERVER if hasattr(settings, 'MOOSHELL_FORCE_SHOW_SERVER') else None,
			'SPECIAL_HEAD_CODE': settings.MOOSHELL_SPECIAL_HEAD_CODE if hasattr(settings, 'MOOSHELL_SPECIAL_HEAD_CODE') else None,
			}
