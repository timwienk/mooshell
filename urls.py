...
urlpatterns = patterns('mooshell.views',
    ...
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/$','pastie_edit', name='author_pastie'),
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/(?P<skin>\w+)/$','pastie_edit'),
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/(?P<version>\d+)/$','pastie_edit', name='author_shell'),
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/(?P<version>\d+)/(?P<skin>\w+)/$','pastie_edit'),
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/(?P<version>\d+)$','pastie_edit', name='author_shell_no_slash'),
    url(r'^u/(?P<author>\w+)/(?P<slug>\w+)/(?P<version>\d+)/(?P<revision>\d+)/$','pastie_edit', name='author_revision'),
